...
## Dataset settings:
flags.DEFINE_string('dataset', 'pathology', 'set the dataset')  # --> pacs, pathology
if FLAGS.dataset == "pacs":
    ...
    flags.DEFINE_string('target_domain', '40', 'set the target domain')
...
## Training options
flags.DEFINE_integer('train_iterations', 4001, 'number of training iterations.')
...
flags.DEFINE_integer('which_checkpoint_to_load', 650,
